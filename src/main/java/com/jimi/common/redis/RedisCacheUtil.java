...
public class RedisCacheUtil {
     ...
     * @return 缓存键值对应的数据
     */
    public <T> T lPopCacheList(final String key) {
        ListOperations<String, T> operations = redisTemplate.opsForList();
     ...
     * @return 缓存键值对应的数据
     */
    public <T> T rPopCacheList(final String key) {
        ListOperations<String, T> operations = redisTemplate.opsForList();
     ...
     * @return 缓存的对象
     */
    public <T> Long delCacheListValue(final String key, final String value) {
        ListOperations<String, T> operations = redisTemplate.opsForList();
     ...
     * @return Hash中的对象
     */
    public <T> Long delCacheMapValue(final String key, final String hKey) {
        HashOperations<String, String, T> opsForHash = redisTemplate.opsForHash();
